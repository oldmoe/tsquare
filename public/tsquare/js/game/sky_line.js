var SkyLine = Class.create({
	...
	initialize: function(scene){
      ...
      var background_layer2 = new Background(this.scene, {speed : function(){return  self.scene.direction*(self.scene.currentSpeed-2)}, y: -5, imagesCount: 2, images:images_layer2})
      ...
      var background_crowd = new Background(this.scene, {speed : function(){return  self.scene.direction*(self.scene.currentSpeed)}, y: 250, imagesCount: 2, images:images_crowd, offsetX:0});
