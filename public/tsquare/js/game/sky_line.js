var SkyLine = Class.create({
	...
	initialize: function(scene){
      ...
      var background_clowd = new Background(this.scene, {speed : function(){return  self.scene.direction * self.scene.currentSpeed + 1 }, y: 0, imagesCount: 3, images:images_clowd, offsetX:0, alwaysMove : true});
      ...
      var background_road = new Background(this.scene, {speed : function(){return  self.scene.direction*(self.scene.currentSpeed)}, y: 240, imagesCount: 2, offsetX:0, images:images_road})

      var background_layer1 = new Background(this.scene, {speed : function(){return  self.scene.direction*(self.scene.currentSpeed-1)}, y: 7, imagesCount: 2, images:images_layer1})

      var background_crowd = new Background(this.scene, {speed : function(){return  self.scene.direction*(self.scene.currentSpeed-1)}, y: 128, imagesCount: 4, images:images_crowd, offsetX:0});
      var background_fence = new Background(this.scene, {speed : function(){return  self.scene.direction*(self.scene.currentSpeed)}, y: 250, imagesCount: 14, images:images_fence})
      var background_lamp = new Background(this.scene, {speed : function(){return  self.scene.direction*(self.scene.currentSpeed)}, y: 100, imagesCount: 3, images:images_lamp})
