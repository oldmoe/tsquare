var ClashEnemyCarrierDisplay = Class.create(Display,{
  noOfFrames : 8,
   ...
   createSprites : function(){
    ...
    this.sprites.carrier = new DomImgSprite(this.owner,{img:this.img, noOfFrames:this.noOfFrames})
  },
  render : function($super){
      this.sprites.carrier.currentAnimationFrame = (this.sprites.carrier.currentAnimationFrame + 1) % this.noOfFrames
      $super()
  }
