...
var AudioManager = Class.create({
    ...
    this.levels = [
      {tempo: 130, beats : [{beat : 0, volume : 95}]},//90

      {tempo: 130, beats : [{beat : 0, volume : 95}, {beat : 1, volume : 20}]},
      {tempo: 130, beats : [{beat : 0, volume : 95}, {beat : 1, volume : 20}]},
      
      {tempo: 130, beats : [{beat : 0, volume : 95}, {beat : 1, volume : 30}, {beat : 2, volume : 10}]},
      {tempo: 130, beats : [{beat : 0, volume : 95}, {beat : 1, volume : 30}, {beat : 2, volume : 10}]}
/*      
...
*/		
		...
		scene.observe('wrongPowerupSound', function(){self.playWrongPowerSound()});
  ...
  playPowerupSound: function(){
	...
	playKeySound: function(keyIndex){
      ...
      if(sound.playState){
	    ...
	    sound.play({volume:25, position:50});
  ...
  playWrongPowerSound: function(){
    Loader.sounds['sfx']['wrong_move.mp3'].play({volume:30})
  },
